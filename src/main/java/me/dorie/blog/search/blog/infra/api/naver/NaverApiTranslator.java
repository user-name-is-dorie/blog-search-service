...
@Component
public class NaverApiTranslator {
    private static final DateTimeFormatter DATE_TIME_FORMATTER = DateTimeFormatter.ofPattern("yyyyMMdd");

    public List<Blog> translateToBlogs(List<NaverApiDto.BlogSearchResponse.Item> items) {
        return items.stream()
    ...
    public NaverApiDto.BlogSearchRequest translateToRequest(BlogSearchCriteria criteria) {
